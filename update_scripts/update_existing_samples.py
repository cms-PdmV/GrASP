...
def process_request(cursor, campaign_uid, request):
    ...
    for chained_request in chained_requests:
        ...
        entry = {'campaign_uid': campaign_uid,
                 ...
                 'root_request_total_events': max(0, root_request['total_events']),
                 'root_request_done_events': max(0, root_request['completed_events']),
                 ...
                 'miniaod_total_events': max(0, miniaod_total_events or 0),
                 'miniaod_done_events': max(0, miniaod_done_events or 0),
